...
output "etl_container_name" {
  ...
  description = "Container that stores the project data"
}

output "etl_stagingarea_name" {
  value       = var.staging_container_name
  description = "Container that stores the cleaned data"
}

output "raw_data_directory" {
  value = var.raw_data_dirname
  description = "Directory that contains the raw level data"
}

output "access_data_directory" {
  value = var.access_data_dirname
  description = "Directory that contains the access level data"
}
